...
public:
    Manpower(int quantity, const std::string sprite, int available, int health, double moral) : Resources(quantity, sprite, "Manpower"), available(available), health(health), moral(moral), feed(false) {};
